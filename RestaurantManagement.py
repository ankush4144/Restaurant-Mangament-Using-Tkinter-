...
class calculation:                      #class with all the functions
    ...
    def modeOfPayment(self):
        ...
        canvas = Canvas(calculation.second, bg='royalblue3',height=300,width=400)   
        canvas.grid()
        canvas.create_text(200,20,fill="snow",font="Times 12 bold",text="PLEASE ENTER YOUR MODE OF PAYMENT")   
        Radiobutton(calculation.second,text="CASH",value="CASH",bg='royalblue3',variable=mode,indicatoron=0,width=25,command=self.finalExit).place(x=100,y=50)
        Radiobutton(calculation.second,text="DEBIT CARD",value="DEBIT CARD",bg='royalblue1',variable=mode,indicatoron=0,width=25,command=self.finalExit).place(x=100,y=80)
        Radiobutton(calculation.second,text="CREDIT CARD",value="CREDIT CARD",bg='royalblue3',variable=mode,indicatoron=0,width=25,command=self.finalExit).place(x=100,y=110)
        Radiobutton(calculation.second,text="NETBANKING",value="NETBANKING",bg='royalblue1',variable=mode,indicatoron=0,width=25,command=self.finalExit).place(x=100,y=140)
        Radiobutton(calculation.second,text="PAYTM/UPI",value="PAYTM/UPI",bg='royalblue3',variable=mode,indicatoron=0,width=25,command=self.finalExit).place(x=100,y=170)
